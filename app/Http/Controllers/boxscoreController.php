        ...
        else
        {
            ...
            try {
                ...
                foreach($csv_file as $csv)
                {
                    ...
                    $csv_import = new boxscore(['game_string' => $game_string,
                        'datey' => $datey,
                        'dashy_date' => $dashy_date,
                        'afname' => $afname,
                        'hfname' => $hfname,
                        'atotal' => $atotal,
                        'htotal' => $htotal,
                        ...
                        'ap13_to' => $ap13_to,
                        'ap13_pf' => $ap13_pf,
                        'ap13_starter' => $ap13_starter,
                        'h_nick' => $h_nick,
                        'a_nick' => $a_nick,
                        'h_initials' => $h_initials,
                        'a_initials' => $a_initials,
                        'aq1' => $aq1,
                        'aq2' => $aq2,
                        'aq3' => $aq3,
                        'aq4' => $aq4,
                        ...
                        'awaytfgma' => $awaytfgma,
                        'awaytftma' => $awaytftma,
                        'awayt3fgma' => $awayt3fgma,
                        'hometfgma' => $hometfgma,
                        'hometftma' => $hometftma,
                        'homet3fgma' => $homet3fgma,
                        'hometoreb' => $hometoreb,
                        'hometdreb' => $hometdreb,
                        'awaytoreb' => $awaytoreb,
                        'awaytdreb' => $awaytdreb,
