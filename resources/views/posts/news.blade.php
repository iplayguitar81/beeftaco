        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                ...
                @foreach($news as $item)
                    ...
                    <div class="row">
                        <div class="col-sm-4"><h3 class="title"><a class="" href="{{ route('posts.show', [$item->id, str_slug($item->title)]) }}">{{ $item->title}}</a></h3><a class="" href="{{ route('posts.show', [$item->id, str_slug($item->title)]) }}"><img src="../images/md-img-{{ $item->imgPath}}" class="img-responsive"></a>
