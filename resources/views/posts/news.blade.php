    ...
    <div class="row">
        ...
        @foreach($news as $item)
            ...
            <div class="col-sm-3">
                ...
                <a class="btn btn-md active" href="{{url('news/general')}}">More Team News...</a>
                <br/>
                <br/>
        ...
        <div class="col-sm-3">
            ...
            <a class="btn btn-md active" href="{{url('news/retro')}}">More Retro News...</a>
        <br/>
        <br/>
        ...
        @endforeach
            ...
            @foreach($former_players as $item)
                ...
                <div class="col-sm-3">
                    ...
                    <a class="btn btn-md active" href="{{url('news/former-players')}}">More Alum News...</a>
                    <br/>
                    <br/>
            ...
            @foreach($nbanews as $item)
                ...
                <div class="col-sm-3">
                    ...
                    <a class="btn btn-md active" href="{{url('news/nba')}}">More League News...</a>
                    <br/>
                    <br/>
                </div>
            @endforeach
