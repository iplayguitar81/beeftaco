...
<head>
    ...
    <title>TrailBlazers Fans | @yield('title') </title>
...
<script  src="{{url('/js/photoswipe.min.js')}}" defer></script>
<script  src="{{url('/js/photoswipe-ui-default.min.js')}}" defer></script>
<script  src="{{url('/js/lightslider.js')}}" defer></script>
