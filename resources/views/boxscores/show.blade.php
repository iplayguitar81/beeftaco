...
@if($boxscore->a_initials=="POR")
    ...
    @endif
        ...
        <table id='boxscore_away'>
            ...
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class2 }}' >{{$boxscore->ap2_name}}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{$boxscore->ap2_min}}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{$boxscore->ap2_pts}}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_fgma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_3pma }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_dreb }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_reb }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_to }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_this'>$a_starter1</td></tr>
            ...
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class6 }}'>{{$boxscore->ap6_name}}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{$boxscore->ap6_min}}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{$boxscore->ap6_pts}}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_fgma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_3pma }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_dreb }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_reb }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_to }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_this'>$a_starter5</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class7 }}'>{{$boxscore->ap7_name}}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{$boxscore->ap7_min}}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{$boxscore->ap7_pts}}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_fgma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_3pma }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_dreb }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_reb }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_to }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_this'>$a_starter6</td></tr>
