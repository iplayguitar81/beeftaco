...
<br/>
        <table id='boxscore_home'>
            ...
            <tr style='border: 1px inset #000;'><td class='{{$astart_class4}}'>{{$boxscore->hp4_name}}</td><td class='{{$astart_class4}}' style='border: 1px inset #000;'>{{$boxscore->hp4_min}}</td><td class='{{$astart_class4}}' style='border: 1px inset #000;'>{{$boxscore->hp4_pts}}</td><td class='{{$astart_class4}}' style='border: 1px inset #000;'>{{ $boxscore->hp4_fgma }}</td><td style='border: 1px inset #000;' class='{{$astart_class4}} hide_box_column'>{{ $boxscore->hp4_3pma }}</td><td class='{{$astart_class4}}' style='border: 1px inset #000;'>{{ $boxscore->hp4_ftma }}</td><td style='border: 1px inset #000;' class='{{$astart_class4}} hide_box_column'>{{ $boxscore->hp4_oreb }}</td><td style='border: 1px inset #000;' class='{{$astart_class4}} hide_box_column'>{{ $boxscore->hp4_dreb }}</td><td class='{{$astart_class4}}' style='border: 1px inset #000;'>{{ $boxscore->hp4_reb }}</td><td class='{{$astart_class4}}' style='border: 1px inset #000;'>{{ $boxscore->hp4_ast }}</td><td style='border: 1px inset #000;' class='{{$astart_class4}} hide_box_column'>{{ $boxscore->hp4_stl }}</td><td style='border: 1px inset #000;' class='{{$astart_class4}} hide_box_column'>{{ $boxscore->hp4_blk }}</td><td style='border: 1px inset #000;' class='{{$astart_class4}} hide_box_column'>{{ $boxscore->hp4_to }}</td><td class='{{$astart_class4}}' style='border: 1px inset #000;'>{{ $boxscore->hp4_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{$astart_class5}}'>{{$boxscore->hp5_name}}</td><td class='{{$astart_class5}}' style='border: 1px inset #000;'>{{$boxscore->hp5_min}}</td><td class='{{$astart_class5}}' style='border: 1px inset #000;'>{{$boxscore->hp5_pts}}</td><td class='{{$astart_class5}}' style='border: 1px inset #000;'>{{ $boxscore->hp5_fgma }}</td><td style='border: 1px inset #000;' class='{{$astart_class5}} hide_box_column'>{{ $boxscore->hp5_3pma }}</td><td class='{{$astart_class5}}' style='border: 1px inset #000;'>{{ $boxscore->hp5_ftma }}</td><td style='border: 1px inset #000;' class='{{$astart_class5}} hide_box_column'>{{ $boxscore->hp5_oreb }}</td><td style='border: 1px inset #000;' class='{{$astart_class5}} hide_box_column'>{{ $boxscore->hp5_dreb }}</td><td class='{{$astart_class5}}' style='border: 1px inset #000;'>{{ $boxscore->hp5_reb }}</td><td class='{{$astart_class5}}' style='border: 1px inset #000;'>{{ $boxscore->hp5_ast }}</td><td style='border: 1px inset #000;' class='{{$astart_class5}} hide_box_column'>{{ $boxscore->hp5_stl }}</td><td style='border: 1px inset #000;' class='{{$astart_class5}} hide_box_column'>{{ $boxscore->hp5_blk }}</td><td style='border: 1px inset #000;' class='{{$astart_class5}} hide_box_column'>{{ $boxscore->hp5_to }}</td><td class='{{$astart_class5}}' style='border: 1px inset #000;'>{{ $boxscore->hp5_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{$astart_class6}}'>{{$boxscore->hp6_name}}</td><td class='{{$astart_class6}}' style='border: 1px inset #000;'>{{$boxscore->hp6_min}}</td><td class='{{$astart_class6}}' style='border: 1px inset #000;'>{{$boxscore->hp6_pts}}</td><td class='{{$astart_class6}}' style='border: 1px inset #000;'>{{ $boxscore->hp6_fgma }}</td><td style='border: 1px inset #000;' class='{{$astart_class6}} hide_box_column'>{{ $boxscore->hp6_3pma }}</td><td class='{{$astart_class6}}' style='border: 1px inset #000;'>{{ $boxscore->hp6_ftma }}</td><td style='border: 1px inset #000;' class='{{$astart_class6}} hide_box_column'>{{ $boxscore->hp6_oreb }}</td><td style='border: 1px inset #000;' class='{{$astart_class6}} hide_box_column'>{{ $boxscore->hp6_dreb }}</td><td class='{{$astart_class6}}' style='border: 1px inset #000;'>{{ $boxscore->hp6_reb }}</td><td class='{{$astart_class6}}' style='border: 1px inset #000;'>{{ $boxscore->hp6_ast }}</td><td style='border: 1px inset #000;' class='{{$astart_class6}} hide_box_column'>{{ $boxscore->hp6_stl }}</td><td style='border: 1px inset #000;' class='{{$astart_class6}} hide_box_column'>{{ $boxscore->hp6_blk }}</td><td style='border: 1px inset #000;' class='{{$astart_class6}} hide_box_column'>{{ $boxscore->hp6_to }}</td><td class='{{$astart_class6}}' style='border: 1px inset #000;'>{{ $boxscore->hp6_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{$astart_class7}}'>{{$boxscore->hp7_name}}</td><td class='{{$astart_class7}}' style='border: 1px inset #000;'>{{$boxscore->hp7_min}}</td><td class='{{$astart_class7}}' style='border: 1px inset #000;'>{{$boxscore->hp7_pts}}</td><td class='{{$astart_class7}}' style='border: 1px inset #000;'>{{ $boxscore->hp7_fgma }}</td><td style='border: 1px inset #000;' class='{{$astart_class7}} hide_box_column'>{{ $boxscore->hp7_3pma }}</td><td class='{{$astart_class7}}' style='border: 1px inset #000;'>{{ $boxscore->hp7_ftma }}</td><td style='border: 1px inset #000;' class='{{$astart_class7}} hide_box_column'>{{ $boxscore->hp7_oreb }}</td><td style='border: 1px inset #000;' class='{{$astart_class7}} hide_box_column'>{{ $boxscore->hp7_dreb }}</td><td class='{{$astart_class7}}' style='border: 1px inset #000;'>{{ $boxscore->hp7_reb }}</td><td class='{{$astart_class7}}' style='border: 1px inset #000;'>{{ $boxscore->hp7_ast }}</td><td style='border: 1px inset #000;' class='{{$astart_class7}} hide_box_column'>{{ $boxscore->hp7_stl }}</td><td style='border: 1px inset #000;' class='{{$astart_class7}} hide_box_column'>{{ $boxscore->hp7_blk }}</td><td style='border: 1px inset #000;' class='{{$astart_class7}} hide_box_column'>{{ $boxscore->hp7_to }}</td><td class='{{$astart_class7}}' style='border: 1px inset #000;'>{{ $boxscore->hp7_pf }}</td></tr>
