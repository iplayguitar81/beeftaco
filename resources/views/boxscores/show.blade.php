...
{{--This is where I need to add the boxscore recap stuff.....--}}
            @php
                    ...
                    $game_box_recap="The Trail Blazers made ". $boxscore->hometfgma . " shots they attempted resulting in a total team field goal percentage of ". $boxscore->hfgp."% for the game.  Meanwhile, the ". $boxscore->a_nick."  made ". $boxscore->awaytfgma." shots that they attempted resulting in a total team field goal percentage of ". $boxscore->afgp. "% for the game.  The Trail Blazers hit ".$boxscore->hometftma. " free throws shooting " . $boxscore->hftp . "% from the free throw line and the " . $boxscore->a_nick. " hit ".$boxscore->awaytftma." free throws shooting ". $boxscore->aftp."% from the free throw line.  The Trail Blazers made ".$boxscore->homet3fgma." of the 3-pointers they shot resulting in a total team 3 point field goal percentage of ".$boxscore->h3ptp."% and the ".$boxscore->a_nick." made ".$boxscore->awayt3fgma. " of the 3-pointers they shot resulting in a total team 3 pint field goal percentage of ".$boxscore->a3ptp."%.  The Blazers collected ". $boxscore->hometoreb . " offensive rebounds, ". $boxscore->hometdreb . " defensive rebounds for a total of ". $boxscore->hrebt." rebounds and the ".$boxscore->a_nick. " scooped up ".$boxscore->awaytoreb." offensive rebounds, ".$boxscore->awaytdreb." defensive rebounds for a total of ".$boxscore->arebt." rebounds.  The Blazers dished out ".$boxscore->hastt." assists while the ". $boxscore->a_nick . " dished out ".$boxscore->aastt.".  The Blazers collected ".$boxscore->hstlt." steals and the ".$boxscore->a_nick." collected ".$boxscore->astlt. " steals.  The Blazers blocked ".$boxscore->hblkt." of the ".$boxscore->a_nick." shots.  the ".$boxscore->a_nick." blocked ".$boxscore->ablkt." of the Blazers shots.  The Blazers turned the ball over ".$boxscore->hometto." times.  The ".$boxscore->a_nick." turned the ball over ".$boxscore->awaytto." times."."  <br/><br/>  The game was officiated by ".$boxscore->ref1.", ".$boxscore->ref2." and ".$boxscore->ref3."<br/><br/> There were ".$boxscore->attendance. " out of a possible ".$boxscore->capacity." fans in attendace.  This means that ".$boxscore->arena." was " . $attendance_percentage . "% filled to capacity."
...
@if($boxscore->a_initials=="POR")
    ...
    @php
        $game_box_recap="The Trail Blazers made ". $boxscore->awaytfgma . " shots they attempted resulting in a total team field goal percentage of ". $boxscore->afgp."% for the game.  Meanwhile, the ". $boxscore->h_nick."  made ". $boxscore->hometfgma." shots that they attempted resulting in a total team field goal percentage of ". $boxscore->hfgp. "% for the game.  The Trail Blazers hit ".$boxscore->awaytftma. " free throws shooting " . $boxscore->aftp . "% from the free throw line and the " . $boxscore->h_nick. " hit ".$boxscore->hometftma." free throws shooting ". $boxscore->hftp."% from the free throw line.  The Trail Blazers made ".$boxscore->awayt3fgma." of the 3-pointers they shot resulting in a total team 3 point field goal percentage of ".$boxscore->a3ptp."% and the ".$boxscore->h_nick." made ".$boxscore->homet3fgma. " of the 3-pointers they shot resulting in a total team 3 point field goal percentage of ".$boxscore->h3ptp."%.  The Blazers collected ". $boxscore->awaytoreb . " offensive rebounds and ". $boxscore->awaytdreb . " defensive rebounds for a total of ". $boxscore->arebt." rebounds and the ".$boxscore->h_nick. " scooped up ".$boxscore->hometoreb." offensive rebounds and ".$boxscore->hometdreb." defensive rebounds for a total of ".$boxscore->hrebt." rebounds.  The Blazers dished out ".$boxscore->aastt." assists while the ". $boxscore->h_nick . " dished out ".$boxscore->hastt.".  The Blazers collected ".$boxscore->astlt." steals and the ".$boxscore->h_nick." collected ".$boxscore->hstlt. " steals.  The Blazers blocked ".$boxscore->ablkt." of the ".$boxscore->h_nick." shots.  The ".$boxscore->h_nick." blocked ".$boxscore->hblkt." of the Blazers shots.  The Blazers turned the ball over ".$boxscore->awaytto." times.  The ".$boxscore->h_nick. " turned the ball over ".$boxscore->hometto." times.<br/><br/>  The game was officiated by ".$boxscore->ref1.", ".$boxscore->ref2." and ".$boxscore->ref3."<br/><br/> There were ".$boxscore->attendance. " out of a possible ".$boxscore->capacity." fans in attendance.  This means that ".$boxscore->arena." was " . $attendance_percentage . "% filled to capacity."
...
$test_to= $ap1_to .
        ...
        <table id='last_game_period_box'>
            <tr><th>&nbsp;</th><th>&nbsp;</th><th>1</th><th>2</th><th>3</th><th>4</th>@if ($boxscore->aq5 == 0 || $boxscore->aq5 == '') @else <th>OT1</th>@endif
        ...
        <table id='boxscore_away'>
            ...
            <tr style='border: 1px inset #000;'><td class=''> {{$boxscore->ap1_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->ap1_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->ap1_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->ap1_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->ap1_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->ap1_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->ap1_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->ap1_pf }}</td></tr>
...
<br/>
        <table id='boxscore_home'>
            ...
            <tr style='border: 1px inset #000;'><td class=''> {{$boxscore->hp1_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp1_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp1_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp1_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp1_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp1_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp1_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp1_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp1_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp1_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp1_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp1_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp1_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp1_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class='' >{{$boxscore->hp2_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp2_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp2_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp2_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp2_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp2_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp2_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp2_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp2_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp2_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp2_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp2_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp2_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp2_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp3_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp3_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp3_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp3_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp3_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp3_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp3_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp3_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp3_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp3_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp3_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp3_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp3_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp3_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp4_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp4_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp4_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp4_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp4_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp4_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp4_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp4_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp4_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp4_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp4_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp4_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp4_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp4_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp5_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp5_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp5_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp5_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp5_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp5_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp5_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp5_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp5_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp5_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp5_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp5_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp5_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp5_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp6_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp6_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp6_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp6_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp6_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp6_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp6_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp6_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp6_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp6_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp6_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp6_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp6_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp6_pf }}</td></tr>
            <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp7_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp7_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp7_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp7_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp7_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp7_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp7_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp7_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp7_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp7_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp7_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp7_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp7_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp7_pf }}</td></tr>


            @if( notNullValue($boxscore->hp8_name) )

                <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp8_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp8_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp8_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp8_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp8_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp8_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp8_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp8_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp8_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp8_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp8_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp8_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp8_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp8_pf }}</td></tr>
            @else

            @endif


            @if( notNullValue($boxscore->hp9_name) )

                <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp9_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp9_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp9_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp9_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp9_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp9_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp9_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp9_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp9_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp9_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp9_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp9_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp9_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp9_pf }}</td></tr>
            @else

            @endif

            @if( notNullValue($boxscore->hp10_name) )
                <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp10_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp10_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp10_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp10_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp10_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp10_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp10_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp10_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp10_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp10_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp10_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp10_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp10_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp10_pf }}</td></tr>
            @else

            @endif


            @if( notNullValue($boxscore->hp11_name)  )

                <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp11_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp11_min}}</td><td style='border: 1px inset #000;'>{{$boxscore->hp11_pts}}</td><td style='border: 1px inset #000;'>{{ $boxscore->hp11_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp11_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp11_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp11_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp11_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp11_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp11_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp11_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp11_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp11_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp11_pf }}</td></tr>
            @else

            @endif

            @if( notNullValue($boxscore->hp12_name)  )

                <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp12_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp12_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp12_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp12_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp12_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp12_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp12_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp12_dreb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp12_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp12_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp12_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp12_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp12_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp12_pf }}</td></tr>
            @else
            ...
            @if( notNullValue($boxscore->hp13_name) )
                ...
                <tr style='border: 1px inset #000;'><td class=''>{{$boxscore->hp13_name}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp13_min}}</td><td class='' style='border: 1px inset #000;'>{{$boxscore->hp13_pts}}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp13_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp13_3pma }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp13_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp13_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp13_dreb }}</td><td class='' style='border: 1px inset #000;' >{{ $boxscore->hp13_reb }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp13_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp13_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp13_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->hp13_to }}</td><td class='' style='border: 1px inset #000;'>{{ $boxscore->hp13_pf }}</td><td style='border: 1px inset #000;' class=' hide_this'></td></tr>
        ...
        <table id="box_team_total_percentages">
            ...
            <tr style="border: 1px inset #000;"><td style="border: 1px inset #000;font-weight:800;">{{ strtolower($boxscore->a_nick) }}</td><td style="border: 1px inset #000;">{{ $boxscore->atotal }}</td><td style="border: 1px inset #000;">{{ $boxscore->afgp }}</td><td style="border: 1px inset #000;">{{ $boxscore->aftp }}</td><td style="border: 1px inset #000;">{{ $boxscore->a3ptp }}</td><td style="border: 1px inset #000;">{{ $boxscore->arebt }}</td><td style="border: 1px inset #000;">{{ $boxscore->aastt }}</td><td style="border: 1px inset #000;">{{ $boxscore->astlt }}</td><td style="border: 1px inset #000;">{{ $boxscore->ablkt }}</td><td style="border: 1px inset #000;">{{ $away_total_to }}</td><td style="border: 1px inset #000;">{{ $boxscore->awaytpf }}</td></tr>
            <tr style="border: 1px inset #000;"><td style="border: 1px inset #000;font-weight:800;">{{ strtolower($boxscore->h_nick) }}</td><td style="border: 1px inset #000;">{{ $boxscore->htotal }}</td><td style="border: 1px inset #000;">{{ $boxscore->hfgp }}</td><td style="border: 1px inset #000;">{{ $boxscore->hftp }}</td><td style="border: 1px inset #000;">{{ $boxscore->h3ptp }}</td><td style="border: 1px inset #000;">{{ $boxscore->hrebt }}</td><td style="border: 1px inset #000;">{{ $boxscore->hastt }}</td><td style="border: 1px inset #000;">{{ $boxscore->hstlt }}</td><td style="border: 1px inset #000;">{{ $boxscore->hblkt }}</td><td style="border: 1px inset #000;">{{ $home_total_to }}</td><td style="border: 1px inset #000;">{{ $boxscore->hometpf }}</td></tr>
            </tbody></table>
        <br/>
