...
$test_to= $ap1_to .
        ...
        <div class='box_score'><h2 class='story_h2'><span class='article_title'>{!! $home_or_away !!}</span><br/><span class='box_arena_h2'>{{$boxscore->arena}} | </span><span class='box_start_date_h2'>{{$game_date}}</span><br/>{!! $win_or_loss !!}</h2></div>
