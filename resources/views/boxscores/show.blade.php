...
$test_to= $ap1_to .
        ...
        <table id='boxscore_away'>
            ...
            <tr style='border: 1px inset #000;'><td class='{{$astart_class1}}'> {{$boxscore->ap1_name}}</td><td class='{{$astart_class1}}' style='border: 1px inset #000;'>{{$boxscore->ap1_min}}</td><td class='{{$astart_class1}}' style='border: 1px inset #000;'>{{$boxscore->ap1_pts}}</td><td class='{{$astart_class1}}' style='border: 1px inset #000;'>{{ $boxscore->ap1_fgma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_3pma }}</td><td class='{{$astart_class1}}' style='border: 1px inset #000;'>{{ $boxscore->ap1_ftma }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_oreb }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_dreb }}</td><td class='{{$astart_class1}}' style='border: 1px inset #000;'>{{ $boxscore->ap1_reb }}</td><td class='{{$astart_class1}}' style='border: 1px inset #000;'>{{ $boxscore->ap1_ast }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_stl }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_blk }}</td><td style='border: 1px inset #000;' class=' hide_box_column'>{{ $boxscore->ap1_to }}</td><td class='{{$astart_class1}}' style='border: 1px inset #000;'>{{ $boxscore->ap1_pf }}</td></tr>
