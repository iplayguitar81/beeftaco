...
@if($boxscore->a_initials=="POR")
    ...
    @endif
        ...
        <table id='boxscore_away'>
            ...
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class1 }}'> {{$boxscore->ap1_name}}</td><td class='{{ $astart_class1 }}' style='border: 1px inset #000;'>{{$boxscore->ap1_min}}</td><td class='{{ $astart_class1 }}' style='border: 1px inset #000;'>{{$boxscore->ap1_pts}}</td><td class='{{ $astart_class1 }}' style='border: 1px inset #000;'>{{ $boxscore->ap1_fgma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class1 }} hide_box_column'>{{ $boxscore->ap1_3pma }}</td><td class='{{ $astart_class1 }}' style='border: 1px inset #000;'>{{ $boxscore->ap1_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class1 }} hide_box_column'>{{ $boxscore->ap1_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class1 }} hide_box_column'>{{ $boxscore->ap1_dreb }}</td><td class='{{ $astart_class1 }}' style='border: 1px inset #000;'>{{ $boxscore->ap1_reb }}</td><td class='{{ $astart_class1 }}' style='border: 1px inset #000;'>{{ $boxscore->ap1_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class1 }} hide_box_column'>{{ $boxscore->ap1_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class1 }} hide_box_column'>{{ $boxscore->ap1_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class1 }} hide_box_column'>{{ $boxscore->ap1_to }}</td><td class='{{ $astart_class1 }}' style='border: 1px inset #000;'>{{ $boxscore->ap1_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class1 }} hide_this'>$a_starter0</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class2 }}' >{{$boxscore->ap2_name}}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{$boxscore->ap2_min}}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{$boxscore->ap2_pts}}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_3pma }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_dreb }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_reb }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_box_column'>{{ $boxscore->ap2_to }}</td><td class='{{ $astart_class2 }}' style='border: 1px inset #000;'>{{ $boxscore->ap2_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class2 }} hide_this'>$a_starter1</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class3 }}'>{{$boxscore->ap3_name}}</td><td class='{{ $astart_class3 }}' style='border: 1px inset #000;'>{{$boxscore->ap3_min}}</td><td class='{{ $astart_class3 }}' style='border: 1px inset #000;'>{{$boxscore->ap3_pts}}</td><td class='{{ $astart_class3 }}' style='border: 1px inset #000;'>{{ $boxscore->ap3_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class3 }} hide_box_column'>{{ $boxscore->ap3_3pma }}</td><td class='{{ $astart_class3 }}' style='border: 1px inset #000;'>{{ $boxscore->ap3_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class3 }} hide_box_column'>{{ $boxscore->ap3_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class3 }} hide_box_column'>{{ $boxscore->ap3_dreb }}</td><td class='{{ $astart_class3 }}' style='border: 1px inset #000;'>{{ $boxscore->ap3_reb }}</td><td class='{{ $astart_class3 }}' style='border: 1px inset #000;'>{{ $boxscore->ap3_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class3 }} hide_box_column'>{{ $boxscore->ap3_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class3 }} hide_box_column'>{{ $boxscore->ap3_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class3 }} hide_box_column'>{{ $boxscore->ap3_to }}</td><td class='{{ $astart_class3 }}' style='border: 1px inset #000;'>{{ $boxscore->ap3_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class3 }} hide_this'>$a_starter2</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class4 }}'>{{$boxscore->ap4_name}}</td><td class='{{ $astart_class4 }}' style='border: 1px inset #000;'>{{$boxscore->ap4_min}}</td><td class='{{ $astart_class4 }}' style='border: 1px inset #000;'>{{$boxscore->ap4_pts}}</td><td class='{{ $astart_class4 }}' style='border: 1px inset #000;'>{{ $boxscore->ap4_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class4 }} hide_box_column'>{{ $boxscore->ap4_3pma }}</td><td class='{{ $astart_class4 }}' style='border: 1px inset #000;'>{{ $boxscore->ap4_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class4 }} hide_box_column'>{{ $boxscore->ap4_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class4 }} hide_box_column'>{{ $boxscore->ap4_dreb }}</td><td class='{{ $astart_class4 }}' style='border: 1px inset #000;'>{{ $boxscore->ap4_reb }}</td><td class='{{ $astart_class4 }}' style='border: 1px inset #000;'>{{ $boxscore->ap4_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class4 }} hide_box_column'>{{ $boxscore->ap4_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class4 }} hide_box_column'>{{ $boxscore->ap4_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class4 }} hide_box_column'>{{ $boxscore->ap4_to }}</td><td class='{{ $astart_class4 }}' style='border: 1px inset #000;'>{{ $boxscore->ap4_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class4 }} hide_this'>$a_starter3</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class5 }}'>{{$boxscore->ap5_name}}</td><td class='{{ $astart_class5 }}' style='border: 1px inset #000;'>{{$boxscore->ap5_min}}</td><td class='{{ $astart_class5 }}' style='border: 1px inset #000;'>{{$boxscore->ap5_pts}}</td><td class='{{ $astart_class5 }}' style='border: 1px inset #000;'>{{ $boxscore->ap5_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class5 }} hide_box_column'>{{ $boxscore->ap5_3pma }}</td><td class='{{ $astart_class5 }}' style='border: 1px inset #000;'>{{ $boxscore->ap5_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class5 }} hide_box_column'>{{ $boxscore->ap5_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class5 }} hide_box_column'>{{ $boxscore->ap5_dreb }}</td><td class='{{ $astart_class5 }}' style='border: 1px inset #000;'>{{ $boxscore->ap5_reb }}</td><td class='{{ $astart_class5 }}' style='border: 1px inset #000;'>{{ $boxscore->ap5_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class5 }} hide_box_column'>{{ $boxscore->ap5_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class5 }} hide_box_column'>{{ $boxscore->ap5_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class5 }} hide_box_column'>{{ $boxscore->ap5_to }}</td><td class='{{ $astart_class5 }}' style='border: 1px inset #000;'>{{ $boxscore->ap5_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class5 }} hide_this'>$a_starter4</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class6 }}'>{{$boxscore->ap6_name}}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{$boxscore->ap6_min}}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{$boxscore->ap6_pts}}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_3pma }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_dreb }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_reb }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_box_column'>{{ $boxscore->ap6_to }}</td><td class='{{ $astart_class6 }}' style='border: 1px inset #000;'>{{ $boxscore->ap6_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class6 }} hide_this'>$a_starter5</td></tr>
            <tr style='border: 1px inset #000;'><td class='{{ $astart_class7 }}'>{{$boxscore->ap7_name}}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{$boxscore->ap7_min}}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{$boxscore->ap7_pts}}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_3pma }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_dreb }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_reb }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_box_column'>{{ $boxscore->ap7_to }}</td><td class='{{ $astart_class7 }}' style='border: 1px inset #000;'>{{ $boxscore->ap7_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class7 }} hide_this'>$a_starter6</td></tr>



@if( !empty($boxscore->ap8_name) )

    <tr style='border: 1px inset #000;'><td class='{{ $$astart_class8 }}'>{{$boxscore->ap8_name}}</td><td class='{{ $$astart_class8 }}' style='border: 1px inset #000;'>{{$boxscore->ap8_min}}</td><td class='{{ $$astart_class8 }}' style='border: 1px inset #000;'>{{$boxscore->ap8_pts}}</td><td class='{{ $$astart_class8 }}' style='border: 1px inset #000;'>{{ $boxscore->ap8_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $$astart_class8 }} hide_box_column'>{{ $boxscore->ap8_3pma }}</td><td class='{{ $$astart_class8 }}' style='border: 1px inset #000;'>{{ $boxscore->ap8_ftma }}</td><td style='border: 1px inset #000;' class='{{ $$astart_class8 }} hide_box_column'>{{ $boxscore->ap8_oreb }}</td><td style='border: 1px inset #000;' class='{{ $$astart_class8 }} hide_box_column'>{{ $boxscore->ap8_dreb }}</td><td class='{{ $$astart_class8 }}' style='border: 1px inset #000;'>{{ $boxscore->ap8_reb }}</td><td class='{{ $$astart_class8 }}' style='border: 1px inset #000;'>{{ $boxscore->ap8_ast }}</td><td style='border: 1px inset #000;' class='{{ $$astart_class8 }} hide_box_column'>{{ $boxscore->ap8_stl }}</td><td style='border: 1px inset #000;' class='{{ $$astart_class8 }} hide_box_column'>{{ $boxscore->ap8_blk }}</td><td style='border: 1px inset #000;' class='{{ $$astart_class8 }} hide_box_column'>{{ $boxscore->ap8_to }}</td><td class='{{ $$astart_class8 }}' style='border: 1px inset #000;'>{{ $boxscore->ap8_pf }}</td><td style='border: 1px inset #000;' class='{{ $$astart_class8 }} hide_this'>$a_starter7</td></tr>
@else
...
@if( !empty($boxscore->ap9_name) )
    ...
    <tr style='border: 1px inset #000;'><td class='{{ $astart_class9 }}'>{{$boxscore->ap9_name}}</td><td class='{{ $astart_class9 }}' style='border: 1px inset #000;'>{{$boxscore->ap9_min}}</td><td class='{{ $astart_class9 }}' style='border: 1px inset #000;'>{{$boxscore->ap9_pts}}</td><td class='{{ $astart_class9 }}' style='border: 1px inset #000;'>{{ $boxscore->ap9_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class9 }} hide_box_column'>{{ $boxscore->ap9_3pma }}</td><td class='{{ $astart_class9 }}' style='border: 1px inset #000;'>{{ $boxscore->ap9_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class9 }} hide_box_column'>{{ $boxscore->ap9_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class9 }} hide_box_column'>{{ $boxscore->ap9_dreb }}</td><td class='{{ $astart_class9 }}' style='border: 1px inset #000;'>{{ $boxscore->ap9_reb }}</td><td class='{{ $astart_class9 }}' style='border: 1px inset #000;'>{{ $boxscore->ap9_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class9 }} hide_box_column'>{{ $boxscore->ap9_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class9 }} hide_box_column'>{{ $boxscore->ap9_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class9 }} hide_box_column'>{{ $boxscore->ap9_to }}</td><td class='{{ $astart_class9 }}' style='border: 1px inset #000;'>{{ $boxscore->ap9_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class9 }} hide_this'>$a_starter8</td></tr>
@else

@endif

@if( !empty($boxscore->ap10_name) )
    <tr style='border: 1px inset #000;'><td class='{{ $astart_class10 }}'>{{$boxscore->ap10_name}}</td><td class='{{ $astart_class10 }}' style='border: 1px inset #000;'>{{$boxscore->ap10_min}}</td><td class='{{ $astart_class10 }}' style='border: 1px inset #000;'>{{$boxscore->ap10_pts}}</td><td class='{{ $astart_class10 }}' style='border: 1px inset #000;'>{{ $boxscore->ap10_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class10 }} hide_box_column'>{{ $boxscore->ap10_3pma }}</td><td class='{{ $astart_class10 }}' style='border: 1px inset #000;'>{{ $boxscore->ap10_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class10 }} hide_box_column'>{{ $boxscore->ap10_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class10 }} hide_box_column'>{{ $boxscore->ap10_dreb }}</td><td class='{{ $astart_class10 }}' style='border: 1px inset #000;'>{{ $boxscore->ap10_reb }}</td><td class='{{ $astart_class10 }}' style='border: 1px inset #000;'>{{ $boxscore->ap10_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class10 }} hide_box_column'>{{ $boxscore->ap10_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class10 }} hide_box_column'>{{ $boxscore->ap10_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class10 }} hide_box_column'>{{ $boxscore->ap10_to }}</td><td class='{{ $astart_class10 }}' style='border: 1px inset #000;'>{{ $boxscore->ap10_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class10 }} hide_this'>$a_starter9</td></tr>
@else
...
@if( !empty($boxscore->ap11_name)  )
    ...
    <tr style='border: 1px inset #000;'><td class='{{ $astart_class11 }}'>{{$boxscore->ap11_name}}</td><td class='{{ $astart_class11 }}' style='border: 1px inset #000;'>{{$boxscore->ap11_min}}</td><td style='border: 1px inset #000;'>{{$boxscore->ap11_pts}}</td><td style='border: 1px inset #000;'>{{ $boxscore->ap11_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class11 }} hide_box_column'>{{ $boxscore->ap11_3pma }}</td><td class='{{ $astart_class11 }}' style='border: 1px inset #000;'>{{ $boxscore->ap11_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class11 }} hide_box_column'>{{ $boxscore->ap11_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class11 }} hide_box_column'>{{ $boxscore->ap11_dreb }}</td><td class='{{ $astart_class11 }}' style='border: 1px inset #000;'>{{ $boxscore->ap11_reb }}</td><td class='{{ $astart_class11 }}' style='border: 1px inset #000;'>{{ $boxscore->ap11_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class11 }} hide_box_column'>{{ $boxscore->ap11_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class11 }} hide_box_column'>{{ $boxscore->ap11_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class11 }} hide_box_column'>{{ $boxscore->ap11_to }}</td><td class='{{ $astart_class11 }}' style='border: 1px inset #000;'>{{ $boxscore->ap11_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class11 }} hide_this'>$a_starter10</td></tr>
@else
...
@if( !empty($boxscore->ap12_name)  )
    ...
    <tr style='border: 1px inset #000;'><td class='{{ $astart_class12 }}'>{{$boxscore->ap12_name}}</td><td class='{{ $astart_class12 }}' style='border: 1px inset #000;'>{{$boxscore->ap12_min}}</td><td class='{{ $astart_class12 }}' style='border: 1px inset #000;'>{{$boxscore->ap12_pts}}</td><td class='{{ $astart_class12 }}' style='border: 1px inset #000;'>{{ $boxscore->ap12_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class12 }} hide_box_column'>{{ $boxscore->ap12_3pma }}</td><td class='{{ $astart_class12 }}' style='border: 1px inset #000;'>{{ $boxscore->ap12_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class12 }} hide_box_column'>{{ $boxscore->ap12_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class12 }} hide_box_column'>{{ $boxscore->ap12_dreb }}</td><td class='{{ $astart_class12 }}' style='border: 1px inset #000;'>{{ $boxscore->ap12_reb }}</td><td class='{{ $astart_class12 }}' style='border: 1px inset #000;'>{{ $boxscore->ap12_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class12 }} hide_box_column'>{{ $boxscore->ap12_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class12 }} hide_box_column'>{{ $boxscore->ap12_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class12 }} hide_box_column'>{{ $boxscore->ap12_to }}</td><td class='{{ $astart_class12 }}' style='border: 1px inset #000;'>{{ $boxscore->ap12_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class12 }} hide_this'>{{$a_starter11}}</td></tr>
@else
...
@if( !empty($boxscore->ap13_name) )
    ...
    <tr style='border: 1px inset #000;'><td class='{{ $astart_class13 }}'>{{$boxscore->ap13_name}}</td><td class='{{ $astart_class13 }}' style='border: 1px inset #000;'>{{$boxscore->ap13_min}}</td><td class='{{ $astart_class13 }}' style='border: 1px inset #000;'>{{$boxscore->ap13_pts}}</td><td class='{{ $astart_class13 }}' style='border: 1px inset #000;'>{{ $boxscore->ap13_fgma.to_s }}</td><td style='border: 1px inset #000;' class='{{ $astart_class13 }} hide_box_column'>{{ $boxscore->ap13_3pma }}</td><td class='{{ $astart_class13 }}' style='border: 1px inset #000;'>{{ $boxscore->ap13_ftma }}</td><td style='border: 1px inset #000;' class='{{ $astart_class13 }} hide_box_column'>{{ $boxscore->ap13_oreb }}</td><td style='border: 1px inset #000;' class='{{ $astart_class13 }} hide_box_column'>{{ $boxscore->ap13_dreb }}</td><td class='{{ $astart_class13 }}' style='border: 1px inset #000;' >{{ $boxscore->ap13_reb }}</td><td class='{{ $astart_class13 }}' style='border: 1px inset #000;'>{{ $boxscore->ap13_ast }}</td><td style='border: 1px inset #000;' class='{{ $astart_class13 }} hide_box_column'>{{ $boxscore->ap13_stl }}</td><td style='border: 1px inset #000;' class='{{ $astart_class13 }} hide_box_column'>{{ $boxscore->ap13_blk }}</td><td style='border: 1px inset #000;' class='{{ $astart_class13 }} hide_box_column'>{{ $boxscore->ap13_to }}</td><td class='{{ $astart_class13 }}' style='border: 1px inset #000;'>{{ $boxscore->ap13_pf }}</td><td style='border: 1px inset #000;' class='{{ $astart_class13 }} hide_this'>{{$a_starter12}}</td></tr>
