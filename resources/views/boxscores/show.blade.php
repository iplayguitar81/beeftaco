...
<br/>
        ...
        <table id="box_team_total_percentages">
            ...
            <tr style="border: 1px inset #000;"><td style="border: 1px inset #000;font-weight:800;">{{ strtolower($boxscore->a_nick) }}</td><td style="border: 1px inset #000;">{{ $boxscore->atotal }}</td><td style="border: 1px inset #000;">{{ $boxscore->afgp }}</td><td style="border: 1px inset #000;">{{ round($boxscore->aftp, 2) }}</td><td style="border: 1px inset #000;">{{ $boxscore->a3ptp }}</td><td style="border: 1px inset #000;">{{ $boxscore->arebt }}</td><td style="border: 1px inset #000;">{{ $boxscore->aastt }}</td><td style="border: 1px inset #000;">{{ $boxscore->astlt }}</td><td style="border: 1px inset #000;">{{ $boxscore->ablkt }}</td><td style="border: 1px inset #000;">{{ $away_total_to }}</td><td style="border: 1px inset #000;">{{ $boxscore->awaytpf }}</td></tr>
