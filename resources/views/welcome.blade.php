            ...
            @endif
                ...
                <div class="item">
                    ...
                    <table class="header_last_game">
                        ...
                        <tr><td colspan="3"><br/><a class="btn btn-danger btn-xs" role="button" aria-pressed="true" href="{{ route('boxscores.show', [$item->id, str_slug($item->game_string)]) }}">Boxscore</a></td></tr>
                        </table>
