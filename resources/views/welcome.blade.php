            ...
            @endif
                ...
                <div class="item">
                    ...
                    <table class="header_last_game">
                        ...
                        <tr><td colspan="3"><a class="btn btn-primary btn-sm" role="button" aria-pressed="true" href="{{ route('boxscores.show', [$item->id, str_slug($item->game_string)]) }}">Boxscore</a></td></tr>
                        </table>
